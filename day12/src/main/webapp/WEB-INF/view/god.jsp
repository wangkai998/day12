...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveGod.htm">
	...
	<div class="modal fade" id="modal_user_tc" role="dialog" aria-labelledby="modal_user_tc" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_tc" method="post" action="reserveGoodt.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>名称：</td>
	...
	<div class="modal fade" id="modal_user_echarts" role="dialog" aria-labelledby="modal_user_echarts" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head"> 表图  </h4>
				</div>
				<div class="modal-body">
